...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Set-2024 às 14:11
...
(1, '2024-01-01', '2024-12-31', '1545.57', 1, 1, 1),
(2, '2024-02-01', '2025-01-31', '2714.40', 2, 2, 2),
(3, '2024-03-01', '2025-02-28', '1161.81', 3, 3, 3),
(4, '2024-04-01', '2025-03-31', '2138.75', 4, 4, 4),
(5, '2024-05-01', '2025-04-30', '2778.75', 5, 5, 5),
(6, '2024-06-01', '2025-05-31', '9999.99', 6, 6, 11),
(7, '2024-07-01', '2025-06-30', '2447.64', 7, 7, 12),
(8, '2024-08-01', '2025-07-31', '2191.40', 8, 8, 13),
(9, '2024-09-01', '2025-08-31', '2552.94', 9, 9, 14),
(10, '2024-10-01', '2025-09-30', '2246.40', 10, 10, 15);
...
(4, 1, 1, 60, b'0', 'Jardim', b'0', b'1', 10),
(5, 2, 3, 110, b'1', 'Escritório', b'0', b'0', 9),
(6, 2, 4, 140, b'1', 'Sauna', b'1', b'1', 11),
(7, 1, 2, 90, b'0', 'Depósito', b'0', b'0', 14),
(8, 3, 5, 200, b'1', 'Quadra de esportes', b'1', b'1', 10),
(9, 2, 3, 130, b'1', 'Playground', b'0', b'1', 13),
(10, 1, 2, 75, b'0', 'Sala de jogos', b'0', b'0', 11),
(11, 2, 3, 120, b'1', 'Churrasqueira', b'0', b'1', 15),
(12, 1, 2, 80, b'0', 'Varanda', b'0', b'0', 9),
(13, 3, 4, 150, b'1', 'Área Gourmet', b'1', b'1', 12),
(14, 1, 1, 60, b'0', 'Jardim', b'0', b'1', 10),
(15, 2, 3, 110, b'1', 'Escritório', b'0', b'0', 8),
(16, 2, 4, 140, b'1', 'Sauna', b'1', b'1', 11),
(17, 1, 2, 90, b'0', 'Depósito', b'0', b'0', 7),
(18, 3, 5, 200, b'1', 'Quadra de esportes', b'1', b'1', 8),
(19, 2, 3, 130, b'1', 'Playground', b'0', b'1', 10),
(20, 1, 2, 75, b'0', 'Sala de jogos', b'0', b'0', 7),
(21, 2, 3, 125, b'1', 'Sala de TV', b'0', b'1', 9),
(22, 1, 1, 70, b'0', 'Cozinha planejada', b'0', b'0', 9),
(23, 3, 4, 160, b'1', 'Academia', b'1', b'1', 8),
(24, 2, 3, 115, b'1', 'Escritório', b'0', b'1', 10),
(25, 1, 2, 85, b'0', 'Despensa', b'0', b'0', 8);
...
(1, 'Mariana Silva', '11122233355', 'mariana.silva@yahoo.com', '1995-04-08', 1, '2000.00'),
(2, 'Gabriel Costa', '66677788811', 'gabriel.costa@gmail.com', '1990-09-18', 2, '9999.99'),
(3, 'Eduardo Lima', '44455566688', 'eduardo.lima@hotmail.com', '1983-02-13', 3, '6932.00'),
(4, 'Rafaela Souza', '99988877722', 'rafaela.souza@outlook.com', '1992-12-05', 4, '1243.99'),
(5, 'Thiago Melo', '22233344499', 'thiago.melo@yahoo.com', '1988-07-14', 5, '1982.00'),
(6, 'Gabriela Nogueira', '11199988822', 'gabriela.nogueira@gmail.com', '1996-07-03', 6, '8723.00'),
(7, 'Renato Sampaio', '33344455588', 'renato.sampaio@email.com', '1991-11-28', 7, '2000.00'),
(8, 'Clarice Batista', '88899977733', 'clarice.batista@outlook.com', '1985-01-09', 8, '1376.00'),
(9, 'Pedro Henrique', '22233344455', 'pedro.henrique@yahoo.com', '1994-09-21', 9, '1652.00'),
(10, 'Carolina Tavares', '77788899966', 'carolina.tavares@gmail.com', '1987-10-18', 10, '9999.99');
...
(1, '1980-05-12', 'Carlos Silva', 'carlos.silva@gmail.com', '12345678901', '+1111999998888', 'Banco do Brasil', '1234', '56789-0', 'carlos.silva@gmail.com', 2),
(2, '1975-08-23', 'Maria Oliveira', 'maria.oliveira@email.com', '10987654321', '+1121988887777', 'Caixa Econômica', '4321', '12345-6', '10987654321', 1),
(3, '1990-02-14', 'José Santos', 'jose.santos@yahoo.com', '11122233344', '+1131977776666', 'Itaú', '5678', '65432-1', 'jose.santos@yahoo.com', 3),
(4, '1985-07-07', 'Ana Costa', 'ana.costa@gmail.com', '55566677788', '+1141966665555', 'Bradesco', '8765', '98765-4', '41966665555', 1),
(5, '1970-03-19', 'Paulo Almeida', 'paulo.almeida@gmail.com', '99988877766', '+1151955554444', 'Santander', '1357', '24680-9', 'paulo.almeida@gmail.com', 2),
(6, '1995-12-30', 'Fernanda Souza', 'fernanda.souza@yahoo.com', '33322211100', '+1161944443333', 'Nubank', '0246', '13579-8', '61944443333', 1),
(7, '1982-11-11', 'Roberto Lima', 'roberto.lima@outlook.com', '44455566677', '+1171933332222', 'Inter', '9753', '02468-1', '44455566677', 1),
(8, '1978-04-25', 'Juliana Martins', 'juliana.martins@hotmail.com', '22233344455', '+1181922221111', 'Sicoob', '8642', '13524-7', 'juliana.martins@hotmail.com', 3),
(9, '1992-09-09', 'Ricardo Barros', 'ricardo.barros@gmail.com', '66677788899', '+1191911110000', 'Banco Original', '7531', '95162-3', '91911110000', 2),
(10, '1988-06-16', 'Patrícia Ferreira', 'patricia.ferreira@yahoo.com', '77788899900', '+1111900001111', 'Banrisul', '6420', '84013-6', 'patricia.ferreira@yahoo.com', 1),
(11, '1983-04-21', 'Rafael Nunes', 'rafael.nunes@email.com', '55544433322', '+1121987654321', 'Itaú', '6789', '01234-5', '55544433322', 1),
(12, '1991-10-02', 'Luciana Fonseca', 'luciana.fonseca@outlook.com', '44433322211', '+1131976543210', 'Bradesco', '3456', '67890-1', '31976543210', 2),
(13, '1987-12-15', 'Gustavo Andrade', 'gustavo.andrade@hotmail.com', '33322211199', '+1141965432109', 'Banco do Brasil', '9101', '11213-4', 'gustavo.andrade@hotmail.com', 1),
(14, '1973-07-30', 'Marcela Vieira', 'marcela.vieira@gmail.com', '22211100088', '+1151954321098', 'Santander', '1121', '41516-7', 'marcela.vieira@gmail.com', 3),
(15, '1999-05-18', 'Bruno Araújo', 'bruno.araujo@yahoo.com', '66655544433', '+1161943210987', 'Caixa Econômica', '1314', '71819-0', '66655544433', 2);
